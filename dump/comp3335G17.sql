...
SET @patients_key = 'Patients key';
SET @staff_key = 'staff key';
...
(AES_ENCRYPT('John Doe', @patients_key, @init_vector, "hkdf"), '1990-05-15', AES_ENCRYPT('john@example.com', @patients_key, @init_vector, "hkdf"), AES_ENCRYPT('Insurance Company A', @patients_key, @init_vector, "hkdf"), @init_vector, 'john_doe', 'pbkdf2:sha256:600000$2GQOX8fIBMPODxuL$237b5461860bcc8cee64b11e49f3b54eb9d0e5b4116b108e2765ffce0f593753'),
(AES_ENCRYPT('Jane Smith', @patients_key, @init_vector1, "hkdf"), '1985-12-10', AES_ENCRYPT('jane@example.com', @patients_key, @init_vector1, "hkdf"), AES_ENCRYPT('Insurance Company B', @patients_key, @init_vector1, "hkdf"), @init_vector1, 'jane_smith', 'pbkdf2:sha256:600000$woyBKh5CUmAx7azh$9d8c951ca72e28b2d372cff2b8dd501c38e1e247f178d1bf49b0b3f004089ea9'),
(AES_ENCRYPT('Michael Johnson', @patients_key, @init_vector2, "hkdf"), '1978-09-20', AES_ENCRYPT('michael@example.com', @patients_key, @init_vector2, "hkdf"), AES_ENCRYPT('Insurance Company C', @patients_key, @init_vector2, "hkdf"), @init_vector2, 'michael_j', 'pbkdf2:sha256:600000$ZoQIW7oqjx1bdDw7$091b7f9bf86a54ed905ffd75e586ff02dd56438cb8e1a1ad0d51d6eb95c34d63');
...
-- BEGIN
--     RETURN SELECT AES_DECRYPT(enc_data, @patients_key, enc_iv, "hkdf") FROM data; 
-- END;
